...
<link rel="preload" as="script" href="/~S151204/scripts/main.js" />
<link rel="preload" as="script" href="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js" />
<link rel="preload" as="script" href="https://www.google-analytics.com/analytics.js" />
<link rel="preload" as="script" href="https://maxcdn.bootstrapcdn.com/js/ie10-viewport-bug-workaround.js" />
<link rel="preload" as="script" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/js/bootstrap.min.js" />
<link rel="preload" as="script" href="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" />
<link rel="preload" as="script" href="https://www.gstatic.com/firebasejs/4.12.1/firebase.js" />
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/babel-polyfill/7.2.5/polyfill.min.js" id="polyfill" async></script>
<script src="/~S151204/scripts/require.js" data-main="/~S151204/scripts/main" nonce="<?php echo $script_nonce?>" id="reqjs" async></script>
<script nonce="<?php echo $script_nonce ?>">
var safeReq = (function () {
    let _queue = [];
    document.getElementById("reqjs").addEventListener("load", function load () {
        document.getElementById("reqjs").removeEventListener("load", load);
        require(["main"], () => {
            _queue.forEach((value) => {
                requirejs(...value);
            });
            _queue = null;
            safeReq = requirejs;
